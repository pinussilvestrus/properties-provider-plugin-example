# Camunda Modeler Properties Provider Plugin Example
...
An example plugin for extending the [Camunda Modeler](https://github.com/camunda/camunda-modeler) properties panel.
